"""
Django settings for Aquacube project.
...
SECRET_KEY = 'django-insecure-&tki190$0$exu(si0dqi7n_b*cyu$0g(jwrk&7qus8r*q37el2'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main_app.context_processors.cart_item_count',
            ],
        },
    },
]

WSGI_APPLICATION = 'Aquacube.wsgi.application'
